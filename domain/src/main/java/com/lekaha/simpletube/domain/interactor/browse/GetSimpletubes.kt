 ...
 */
open class GetSimpletubes constructor(
    val simpletubeRepository: SimpletubeRepository,
    threadExecutor: ThreadExecutor,
    postExecutionThread: PostExecutionThread
) :
    SingleUseCase<List<Simpletube>, Void?>(threadExecutor, postExecutionThread) {

    public override fun buildUseCaseObservable(params: Void?): Single<List<Simpletube>> {
        return simpletubeRepository.getSimpletubes()
    }
